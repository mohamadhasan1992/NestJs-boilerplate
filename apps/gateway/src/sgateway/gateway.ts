...
//     // this.handleConversationJoin(client, conversation)
//   }
...
//     // this.server.to(`conversation-${conversation._id}`).emit(MessengerSocketEventsEnum.userJoin, {_id: client.user._id, fullName: client.user.fullName});
// }
